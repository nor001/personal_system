...
*   Menú — proteína, suplementos, regla ajuste calórico
*   Técnicas de estudio
*   Hábitos — diario / semanal / mensual / trimestral / anual
*   Dashboard semanal — 7 métricas + reglas de ajuste
*   Finanzas — estructura base
*   Datos relevantes
...
**REGLA DE PROGRESIÓN:** Tope alto del rango en todos los sets → aumenta dificultad siguiente sesión. RIR: mayoría de sets a RIR 1–2. Último set de 1–2 ejercicios: RIR 0–1 si te sientes bien.
...
**REGLA ANTI-ESTANCAMIENTO:** Si 2 semanas seguidas el indicador (pull-ups totales u otro) no sube Y el sueño está bien → cambia 1 variable por 2 semanas:

*   +2.5–5% carga en mochila (RDL/Bulgarian), o
*   +1 rep por set hasta tope, o
*   tempo 3s bajada solo en el primer set (pull-up/push-up)

**REGLA DE SEGURIDAD — DIPS:** Sin dolor y con rango controlado. Señal roja: si dolor anterior de hombro aparece durante dips o dura >24–48h → reemplaza dips por 2 semanas completas por: push-up declinado/close-grip, rango reducido, o agarre neutro (anillas).

**SEÑAL DE FATIGA SISTÉMICA:** Si 2–3 días seguidos: sueño "malo" + rendimiento percibido ≤5/10 → esa semana: Tier 2 baja a 1 ronda + Tier 1 todo a RIR 2 + no forzar PRs.
...
**VERSIÓN MÍNIMA (12–15 min) — viajes / días caóticos:** 2–3 rondas sin llegar al fallo:
...
*   Sáb: Zona 2 — 30–45 min fijo (ver regla de garantía)
*   Dom: Descanso real
...
**REGLA DE GARANTÍA — 150 min/sem:** Escenario mínimo: Mar 45 + Jue 45 + Sáb 30 = 120. Para cerrar: micro-cardio 10 min en 3 días de fuerza = 150 ✅
...
_UL vitamina A preformada adultos: 3,000 mcg/día_
...
_Ajustar con analítica 25-OH-D. UL adultos 4,000 IU/día_
...
_UL suplementos adultos ~350mg — bajar si hay malestar GI_
...
*   Zanahoria noche
*   Jengibre dosis culinaria 3–5g + 1 limón + 2 ajo post-entreno

_Interacción con anticoagulantes — ajustar si aplica_
...
_IBKR Lite ($0 en stocks/ETFs USA) es para residentes de EE.UU. Países disponibles incluyen Perú (lista oficial IBKR)._

*   Vehículo: VT (Vanguard Total World) — ~10,000 posiciones, 50+ países, expense ratio 0.06%, un solo ticker

_Si residencia fiscal es UE/EEE: usar equivalente UCITS con KID para exposición global (regulación PRIIPs)._
...
### **Nota fiscal — estate tax (importante si usas ETFs/activos US situs)**

Para no residentes / no ciudadanos USA: el IRS requiere Form 706-NA si los activos situados en EE.UU. superan USD 60,000 al fallecimiento. Esto no cambia la estrategia; obliga a elegir bien el domicilio del ETF y/o planificar.
...
*   ☐ Fuerza (Mié)
*   ☐ Fuerza (Vie)
*   ☐ Zona 2 (Mar) \_\_\_ min
*   ☐ Zona 2 (Jue) \_\_\_ min
*   ☐ Zona 2 (Sáb) \_\_\_ min ← 45–60 si faltan minutos
*   ☐ Micro-cardio post-comida (≥3×)
*   ☐ Sueño promedio \_\_\_ h
*   ☐ Estudio (≥5 días)
*   ☐ Conexión social (1h) + micro (1×)
*   ☐ Dashboard 5 min (Dom o Sáb)

_V6.2 — Parches integrados: sets explícitos Push-up, Versión mínima 12–15 min, Señal fatiga sistémica, Tibialis raises condicional, Regla ajuste calórico, Nota estate tax._